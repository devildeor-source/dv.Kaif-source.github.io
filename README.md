...
<head>  
    ...
    <title>Birthday Surprise - Adrish</title>  
...
<div class="book">  
    ...
    <div class="page cover" id="p1" style="z-index: 4;" onclick="flip('p1')">  
        <h1>Happy Birthday<br>Adrish</h1>  
...
<script>  
    function checkPw() {  
        var str = document.getElementById('pw').value.replace(/\s+/g, '').toLowerCase();  
        
        // Match ASCII array values for 'b','e','t','a','d','a'
        var key = [98, 101, 116, 97, 100, 97];
        var match = true;
